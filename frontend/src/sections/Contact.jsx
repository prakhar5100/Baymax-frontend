    ...
    return (
        <section className="bg-gradient-to-b from-slate-900 to-slate-700">
            <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                ...
                <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Wanna say something to us? Don't Hesitate. <br></br>Let us know!</p>
